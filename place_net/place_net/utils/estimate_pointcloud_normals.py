...
def load_arguments():
    parser = argparse.ArgumentParser(
        ...
        description="Script to estimate the normals for a generic pointcloud. Can also be used to convert to PCD if you already have normals",
    )
...
def main():
    ...
    if pc.has_normals():
        print("Pointcloud already has normals, writing to output file and exiting")
        open3d.io.write_point_cloud(args.output_path, pc, write_ascii=True)
        exit(0)
